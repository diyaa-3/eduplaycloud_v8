...
if (!isset($_SESSION['RF']["userid"] ) || $_SESSION['RF']["userid"]=='')
	{
		$_SESSION['RF']["userid"] = folderid();
	}
if (!file_exists('../images/exercises/'.$_SESSION['RF']["userid"].'/')) {
    mkdir('../images/exercises/'.$_SESSION['RF']["userid"].'/', 0777, true);
}
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/assets/images/exercises/'. $_SESSION['RF']["userid"].'/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../images/exercises/'. $_SESSION['RF']["userid"].'/',
	...
	|
	*/
	'thumbs_base_path' => '../images/exercise/thumbs/'. $_SESSION['RF']["userid"].'/',
