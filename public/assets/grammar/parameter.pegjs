...
variableValue
  = s:StringLiteral { return {  type: 'string' , value: s };}
  / n: NumericLiteral    { return {  type: 'number' , value: n };}
  / ReadFileStatement
  / RandomStatement
  / MathExpression
  // JoinStringStatement
...
ReadFileStatement =  ReadFileToken '(' value:StringLiteral ')' 
					{ return {  type: 'file' , filename: value };}
RandomStatement = RandomToken '.number(' from:DecimalIntegerLiteral  ','
						           to: DecimalIntegerLiteral ',' 
                                    numberType: NumberTypeToken ')'
					{ return {  type: 'random.number' , from: from, to: to ,numberType: numberType };}
                 / RandomToken '.string(' stringType: StringTypeToken ')'
                 	{ return {  type: 'random.string' ,stringType: stringType };}
            
                 / RandomToken '.fromlist(' list:StringLiteral ')'
				{ return {  type: 'random.fromlist' ,list: list };}
            
NumberTypeToken = 'Int' / 'Dec'
StringTypeToken= 'name' / 'city' / ''
MathExpression = MathToken '(' mathExpression:StringLiteral ')'
				{ return {  type: 'math' ,mathExpression: mathExpression };}
            
//JoinStringStatement= JoinStringToken '(' StringLiteral ')'

ReadFileToken= 'readfile'
RandomToken='random'
MathToken=  'math'
JoinStringToken= 'joinstring' 
