;(function ($, window, document, undefined) {
  var pluginName = "countdown360",
    defaults = {
      radius: 0.5,                    // radius of arc
      strokeStyle: "#3fc0df",          // the color of the stroke
      strokeWidth: 1,          // the stroke width, dynamically calulated if omitted in options
      fillStyle: "#f1f1f1",            // the fill color
      fontColor: "#3fc0df",            // the font color
      fontFamily: "roboto",        // the font family
      fontSize: 18,             // the font size, dynamically calulated if omitted in options
