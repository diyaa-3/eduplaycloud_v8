        ...
        _createClass(_class, [{
            ...
            value: function compute() {
                ...
                if (this.CURRENT_PAGE != 1) {
                    ...
                    html.push($('<span />', {
                        class: 'pajinatify__button pajinatify__arrow arrow__prev navigation_button_hide',
                        attr: {
                            'data-page': page
                        }
                    }));
                ...
                if (this.CURRENT_PAGE != this.TOTAL_PAGES) {
                    ...
                    html.push($('<span />', {
                        class: 'pajinatify__button pajinatify__arrow arrow__next navigation_button_hide',
                        attr: {
                            'data-page': page
                        }
                    }));
